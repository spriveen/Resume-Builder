  ...
  >
    ...
    {!hideHeader && (
      ...
      {showActionBtn &&(
       ...
       <button
       type='button'
       className='text-gray-400 bg-transparent hover:bg-gray-200 hover:-gray-900 rounded-lg text-sm w-8 h-8 flex justify-center items-center absolute top-3.5 right-3.5' 
        onClick={onClose}
        >
          <svg
          className='w-3 h-3'
          ...
          >
            <path
              ...
              strokeWidth='2'
              d='M1 1l6 6m0 016 6M7 7l6-6M7 7l-6 6  '
            />
            </svg>
        </button>
